...
import { Bluetooth, Brain, QrCode, Network, Cpu, Activity, Github, ExternalLink } from "lucide-react";
          ...
          {projects.map((project, i) => {
            ...
            return (
              <motion.div
                ...
                className="group bg-card border border-border rounded-xl p-6 hover-lift cursor-default transition-all duration-300 hover:border-primary/40 hover:shadow-[0_0_30px_-8px_hsl(var(--glow)/0.15)]"
              >
